...
{
    /// <summary>
    /// Data model for response on <see cref="GBinanceFuturesClient.Trade.GetNationalBrackets()"/> and
    /// <see cref="GBinanceFuturesClient.Trade.GetNationalBrackets(string)"/> request.
    /// </summary>
